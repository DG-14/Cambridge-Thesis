...
def spawn_points():
    # intersection 2 random loc for pedestrian groups
    c1 = random.uniform(53, 54)
    c2 = random.uniform(48, 49)
    # intersection 3 random loc for pedestrian groups
    c3 = random.uniform(3, 4)
    c4 = random.uniform(9, 10)
    # intersection 4 random loc for pedestrian groups
    c5 = random.uniform(-98, -99)
    c6 = random.uniform(-103, -104)
    # intersection 5 random loc for pedestrian groups
    c7 = random.uniform(4, 5)
    c8 = random.uniform(9, 10)
    # intersection 6 random loc for pedestrian groups
    c9 = random.uniform(57, 58)
    c10 = random.uniform(62, 63)
    # intersection 7 random loc for pedestrian groups
    c11 = random.uniform(-58.5, -57.5)
    c12 = random.uniform(-53.5, -54.5)
    # intersection 8 random loc for pedestrian groups
    c13 = random.uniform(37.56, 45)
    c14 = random.uniform(32.39, 33)
    # intersection 9 random loc for pedestrian groups
    c15 = random.uniform(73,82)
    c16 = random.uniform(58,63)
    # intersection 10 random loc for pedestrian groups
    c17 = random.uniform(-57.64,-52)
    c18 = random.uniform(-42,-30)
    # intersection 11 random loc for pedestrian groups
    c19 = random.uniform(117,118)
    c20 = random.uniform(104,106)
    ...
    spawn_points_dict = {
        ...
        #                                carla.Rotation(pitch=0.0, yaw=90, roll=0.0)),
        #     'cars_motorcycles': [carla.Transform(carla.Location(x=37.18, y=random.uniform(47, 51), z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=90, roll=0.0))],
        #     'bicycles': [carla.Transform(carla.Location(x=37.18, y=random.uniform(46, 42), z=1.0),
        #                               carla.Rotation(pitch=0.0, yaw=90, roll=0.0))],
        #     'pedestrians1': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c13 + i * 0.7, y=57.5+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=180, roll=0.0)) for i in range(5)],
        #     'pedestrians2': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c14 + i * 0.7, y=57.5+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=0, roll=0.0)) for i in range(5)],
        #     'pedestrian_direction': [1, 1, 70]
        # },
        # 'intersection9': {
        #     'ego_car': carla.Transform(carla.Location(x=random.uniform(42, 50), y=73, z=1.0),
        #                                carla.Rotation(pitch=0.0, yaw=0, roll=0.0)),
        #     'cars_motorcycles': [carla.Transform(carla.Location(x=random.uniform(64, 68), y=70, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=0, roll=0.0)),
        #                         carla.Transform(carla.Location(x=random.uniform(73, 79), y=73, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=0, roll=0.0))],
        #     'bicycles': [carla.Transform(carla.Location(x=random.uniform(64, 65), y=73, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=0, roll=0.0))],
        #     'pedestrians1': [carla.Transform(
        #         carla.Location(x=91 + random.uniform(-0.5, 0.5), y=random.uniform(-0.2, 0.2) + c15 + i * 0.7, z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=90, roll=0.0)) for i in range(5)],
        #     'pedestrians2': [carla.Transform(
        #         carla.Location(x=91 + random.uniform(-0.5, 0.5), y=random.uniform(-0.2, 0.2) + c16 + i * 0.7, z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=90, roll=0.0)) for i in range(5)],
        #     'pedestrian_direction': [0, -1, 38]
        # },
        # 'intersection10': {
        #     'ego_car': carla.Transform(carla.Location(x=-48.66, y=random.uniform(72, 79), z=1.0),
        #                                carla.Rotation(pitch=0.0, yaw=90, roll=0.0)),
        #     'cars_motorcycles': [carla.Transform(carla.Location(x=-52, y=88.73, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=90, roll=0.0)),
        #                         carla.Transform(carla.Location(x=-45.16, y=101.5, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=-90, roll=0.0))],
        #     'bicycles': [carla.Transform(carla.Location(x=-48.54, y=106.51, z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=90, roll=0.0))],
        #     'pedestrians1': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c17 + i * 0.7, y=118.5+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=0, roll=0.0)) for i in range(5)],
        #     'pedestrians2': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c18 + i * 0.7, y=118.5+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=180, roll=0.0)) for i in range(5)],
        #     'pedestrian_direction': [1, 1, -44]
        # },
        # 'intersection11': {
        #     'ego_car': carla.Transform(carla.Location(x=106, y=random.uniform(73, 76), z=1.0),
        #                                carla.Rotation(pitch=0.0, yaw=-90, roll=0.0)),
        #     'cars_motorcycles': [carla.Transform(carla.Location(x=109.76, y=random.uniform(60, 63), z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=-90, roll=0.0)),
        #                         carla.Transform(carla.Location(x=98.88, y=random.uniform(48, 51), z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=90, roll=0.0))],
        #     'bicycles': [carla.Transform(carla.Location(x=102, y=random.uniform(22.23, 24.23), z=1.0),
        #                              carla.Rotation(pitch=0.0, yaw=90, roll=0.0))],
        #     'pedestrians1': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c19 + i * 0.7, y=38+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=-180, roll=0.0)) for i in range(5)],
        #     'pedestrians2': [carla.Transform(
        #         carla.Location(x=random.uniform(-0.2, 0.2) + c20 + i * 0.7, y=38+random.uniform(-0.5, 0.5), z=1.0),
        #         carla.Rotation(pitch=0.0, yaw=-180, roll=0.0)) for i in range(5)],
        #     'pedestrian_direction': [1, -1, -44]
        # },

        # # Collision Test cenario based on intersection 6:
        #     'collision': {
        #     'ego_car': carla.Transform(carla.Location(x=random.uniform(0, 10), y=66.280106, z=1.0),
        #                                carla.Rotation(pitch=0.0, yaw=-179.926727, roll=0.0)),
        #     'cars_motorcycles': [],
...
obstacles = {'intersection1_1': [carla.Transform(carla.Location(x=53.5+i, y=34, z=0.0),
             ...
             'intersection8_1': [carla.Transform(carla.Location(x=40.7, y=75+1.5*i, z=0.0),
                                 carla.Rotation(pitch=0, yaw=0, roll=0)) for i in range(int((128-75)/1.5)+1)],
             'intersection8_2': [carla.Transform(carla.Location(x=33, y=103+2.5*i, z=0.0),
                                 carla.Rotation(pitch=0, yaw=0, roll=0)) for i in range(int((128-103)/2.5)+1)],
             'intersection9_1': [carla.Transform(carla.Location(x=40.7, y=75+1.5*i, z=0.0),
                                 carla.Rotation(pitch=0, yaw=0, roll=0)) for i in range(int((128-75)/1.5)+1)],
             'intersection9_2': [carla.Transform(carla.Location(x=33, y=103+2.5*i, z=0.0),
                                 carla.Rotation(pitch=0, yaw=0, roll=0)) for i in range(int((128-103)/2.5)+1)]
             }
